        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-4 w-full overflow-hidden overflow-x-auto align-middle sm:rounded-md">
                            ...
                            @forelse($quizzes as $quiz)
                                <tr class="bg-white">
                                    ...
                                    <td>
                                        ...
                                        <button wire:click="delete({{ $quiz }})" class="rounded-md border border-transparent bg-red-200 px-4 py-2 text-xs uppercase text-red-500 hover:bg-red-300 hover:text-red-700">
                                            Delete
                                        </button>
                                    </td>
                                </tr>
