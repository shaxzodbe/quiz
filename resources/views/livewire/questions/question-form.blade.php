                ...
                <div class="p-6 text-gray-900">
                    <form wire:submit.prevent="save">
                        ...
                        <div class="mt-4">
                            ...
                            @foreach($questionOptions as $index => $questionOption)
                                <div class="flex mt-2">
                                    <x-text-input type="text"
                                                  wire:model.defer="questionOptions.{{ $index }}.option"
                                                  class="w-full"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <button wire:click="removeQuestionOption({{ $index }})" type="button"
                            ...
                            <x-primary-button wire:click="addQuestionOption" type="button" class="mt-2">
                                Add
                            </x-primary-button>
                        </div>
